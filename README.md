...
## Section 6 Retrieval Module

Section 6 adds the production retrieval API. It embeds a query, searches the active default Qdrant
read collection with payload filters, stores traceability rows, and returns retrieved chunks only.
It does not generate final AI answers; external callers or AI agents decide how to use the returned
context.
